...
export default function TicketCheckPage() {
  ...
  return (
    <main className="fixed top-[60px] left-0 right-0 bottom-0 z-50 flex flex-col justify-between bg-black py-6 text-accent-foreground">
      {/* Title Bar */}
      <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-5 relative bottom-[20px] bg-accent h-[64px] w-full">
