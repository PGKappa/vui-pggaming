...
function UpcomingEventItem(props: {
  ...
  return (
    <CarouselItem
      className={`relative flex h-[88px] ${layout.carousel.itemBasis} cursor-pointer flex-row items-center hover:opacity-95 justify-center overflow-hidden border-l-8 border-l-background px-2 py-2 text-[15px] first:border-l-0 last:border-r-background ${
