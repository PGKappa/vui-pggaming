...
export function UpcomingEventsCarousel(props: {
  ...
  return (
    <Carousel className="w-[1370px]">
      <CarouselContent className="-ml-1 bg-white">
        {isLoadingEvents ? (
...
function UpcomingEventItem(props: {
  ...
  return (
    <CarouselItem
      className={`basis-1/7 flex h-[72px] cursor-pointer flex-row items-center justify-center gap-3 px-3 py-2 text-[15px] ${
    ...
    >
      ...
      <div className="flex flex-col items-start pr-2">
        ...
        <div className="flex flex-row gap-2">
          ...
          <span className="font-mono text-[14px] italic pt-[1.9px]">{timeToEventStart}</span>
        </div>
      </div>
    </CarouselItem>
  )
