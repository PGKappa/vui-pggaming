                    ...
                    {filteredEventResults.map((eventResult, index) => {
                      ...
                      return (
                        <AccordionItem
                          ...
                          className="gap-0"
                        >
                          <AccordionTrigger className="mt-2 bg-accent p-0 text-base text-accent-foreground [&[data-state=open]>svg]:-rotate-90">
                            <div className="relative bottom-2 flex w-[600px] flex-row justify-between gap-2 bg-accent text-white">
