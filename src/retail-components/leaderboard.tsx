            ...
            <table className="w-full">
              ...
              <tbody>
                {teamRankings.map((ranking) => (
                  ...
                  >
                    <td
                      className={`p-3 text-center font-bold ${highlightedTeams?.includes(ranking.team) ? 'bg-accent text-accent-foreground' : ''}`}
                    >
                      {ranking.position}
                    </td>
                    <td
                    ...
                    <td className="p-3 text-center">{ranking.goalsAgainst}</td>
