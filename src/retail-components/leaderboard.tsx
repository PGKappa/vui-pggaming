...
export default function Leaderboard({
  ...
  return (
    <Card>
      <CardHeader className="flex h-12 flex-row items-center px-5">
        <CardTitle className="justify-start text-[19px] font-bold">
          {t('standings')}
        </CardTitle>
        <Button variant="ghost" size="icon-lg" onClick={handleToggle}>
          {isExpanded ? (
      ...
      {isExpanded && (
        <CardContent
          className="border-t border-secondary-foreground p-0"
          style={{
            height: '330px',
          }}
        >
              ...
              {teamRankings ? (
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="sticky top-0 bg-card-header">
