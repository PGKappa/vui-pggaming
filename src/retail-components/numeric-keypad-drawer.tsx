...
export default function NumericKeypadDrawer(props: {
  ...
  return (
    ...
    >
      ...
      <DrawerContent className="ml-auto mr-2 w-[396px] border-0 h-[471px]">
        ...
        <div className="flex flex-col gap-3 p-3">
          ...
          <Button
            ...
            className="h-12 w-full bg-bet text-[18px] text-accent-foreground hover:opacity-95 tabular-nums"
          >
            {t('ok')}
          </Button>
        </div>
