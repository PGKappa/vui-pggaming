...
export default function BettingSlip({
  ...
  return (
    <Card
      className="ml-1 grid h-full min-h-0 w-full flex-1 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden bg-primary-foreground text-betSlip-foreground"
              ...
              <TooltipTrigger asChild>
                ...
                >
                  <Image
                    ...
                    width={40}
                    height={20}
                    className="relative bottom-1 left-[7px] ml-[5px] h-[17px] w-6 object-contain brightness-0 invert filter hover:opacity-90"
                  />
                </Button>
              </TooltipTrigger>
