        ...
        <div className="flex h-[41px] w-[396px] flex-row">
          ...
          <div
            className={`relative flex w-full flex-col items-center justify-center border-b-4 ${
              isSystemToggleEnabled ? 'cursor-pointer' : ''
            } ${betMode === 'SYSTEM' ? 'font-normal border-betSlip-header bg-accent' : 'border-accent bg-accent font-normal text-background'}`}
            onClick={
              isSystemToggleEnabled
          ...
          >
            <span
              className={`pt-1 text-[14px] ${betMode === 'SYSTEM' ? 'font-semibold text-betSlip-header' : 'font-semibold text-betSlip-header'}`}
            >
