    ...
    return (
      <TableHeader className="h-14 bg-card-header text-[16px] text-card-header-foreground">
        <TableRow>
          ...
          {activeTab === 'couples' && (
            <>
              <TableHead className="w-[25%] min-w-0 overflow-hidden text-center font-bold min-[1440px]:w-[26%] min-[1880px]:max-[1919px]:w-[27.6%]">
                <span className="inline-block h-full w-full align-middle leading-[54px]">
                  {t('exacta').toUpperCase()}
                </span>
              </TableHead>
              <TableHead className="w-[1px] bg-border p-0" />
              <TableHead className="w-[25%] min-w-0 overflow-hidden text-center font-bold min-[1440px]:w-[24%] min-[1880px]:max-[1919px]:w-[22.4%]">
                <span className="inline-block h-full w-full align-middle leading-[54px]">
          ...
          {activeTab === 'triplets' && (
            <>
              <TableHead className="w-[30%] min-w-0 overflow-hidden text-center font-bold min-[1440px]:w-[32%] min-[1880px]:max-[1919px]:w-[33.1%]">
                <span className="inline-block h-full w-full align-middle leading-[54px]">
                  {t('trifecta').toUpperCase()}
                </span>
              </TableHead>
              <TableHead className="w-[1px] bg-border p-0" />
              <TableHead className="w-[20%] min-w-0 overflow-hidden text-center font-bold min-[1440px]:w-[18%] min-[1880px]:max-[1919px]:w-[16.9%]">
                <span className="inline-block h-full w-full align-middle leading-[54px]">
    ...
    if (activeTab === 'couples') {
      return (
        <>
          ...
          >
            <div className="flex w-full items-center justify-center space-x-[10px] px-0 min-[1360px]:space-x-[8px] min-[1360px]:px-[1px] min-[1440px]:space-x-[11px] min-[1440px]:px-[3px] min-[1600px]:space-x-[21px] min-[1600px]:px-[13px] min-[1760px]:space-x-[32px] min-[1760px]:px-[24px] min-[1880px]:max-[1919px]:space-x-[55px] min-[1920px]:space-x-[42px] min-[1920px]:px-[34px]">
              <Toggle
              ...
              <Toggle
                ...
                onClick={(e) => e.stopPropagation()}
                className="h-[49px] w-[90px] flex-none border-betEntry-border pt-[2px] min-[1380px]:w-[110px] min-[1880px]:max-[1919px]:relative min-[1880px]:max-[1919px]:left-[2px]"
              >
          ...
          >
            <div className="mx-auto flex w-full max-w-[220px] items-center justify-center space-x-2 min-[1440px]:space-x-[2.375rem] min-[1920px]:grid min-[1920px]:max-w-none min-[1920px]:grid-cols-2 min-[1920px]:space-x-0">
              <Toggle
                ...
                onClick={(e) => e.stopPropagation()}
                className={`h-[49px] min-w-0 max-w-[56px] flex-1 border-betEntry-border pt-[2px] min-[1880px]:max-[1919px]:relative min-[1880px]:max-[1919px]:left-[3px] min-[1920px]:mx-auto min-[1920px]:w-[56px] min-[1920px]:max-w-[56px] min-[1920px]:flex-none ${fixedSelection.includes(racer.number) ? 'text-white' : ''}`}
              >
      ...
      return (
        <>
          <TableCell
            ...
            onClick={handleMarketTypeToggle}
          >
            <div className="mx-auto flex w-full items-center justify-center space-x-2 px-4 min-[1440px]:space-x-[9px] min-[1440px]:px-[18px] min-[1600px]:space-x-[13px] min-[1600px]:px-[26px] min-[1760px]:space-x-[18px] min-[1760px]:px-[36px] min-[1880px]:max-[1919px]:space-x-[26px] min-[1920px]:max-w-[400px] min-[1920px]:space-x-[1.375rem] min-[1920px]:px-0">
              <Toggle
                pressed={position1Selection.includes(racer.number)}
                onPressedChange={() => togglePosition1Selection(racer.number)}
                onClick={(e) => e.stopPropagation()}
                className="h-[49px] min-w-0 flex-1 border-betEntry-border pt-[2px] tabular-nums min-[1880px]:max-[1919px]:relative min-[1880px]:max-[1919px]:left-[-9px] min-[1920px]:w-[116px] min-[1920px]:max-w-[116px] min-[1920px]:flex-none"
              >
          ...
          <TableCell
            ...
            onClick={handleMarketTypeToggle}
          >
            <div className="mx-auto flex w-full items-center justify-center space-x-2 px-4 min-[1440px]:space-x-[9px] min-[1440px]:px-[18px] min-[1600px]:space-x-[13px] min-[1600px]:px-[26px] min-[1760px]:space-x-[18px] min-[1760px]:px-[36px] min-[1880px]:max-[1919px]:pr-[20px] min-[1920px]:max-w-[210px] min-[1920px]:space-x-[1.375rem] min-[1920px]:px-0">
              <Toggle
                pressed={fixedSelection.includes(racer.number)}
                onPressedChange={() => toggleFixedSelection(racer.number)}
                onClick={(e) => e.stopPropagation()}
                className={`h-[49px] min-w-0 max-w-[56px] flex-1 border-betEntry-border pt-[2px] min-[1880px]:max-[1919px]:relative min-[1880px]:max-[1919px]:left-[-9px] min-[1920px]:mx-auto min-[1920px]:w-[56px] min-[1920px]:max-w-[56px] min-[1920px]:flex-none ${fixedSelection.includes(racer.number) ? 'text-white' : ''}`}
              >
              ...
              <Toggle
                ...
                onPressedChange={() => toggleDisorderSelection(racer.number)}
                onClick={(e) => e.stopPropagation()}
                className="h-[49px] min-w-0 max-w-[117px] flex-1 border-betEntry-border pt-[2px] tabular-nums min-[1880px]:max-[1919px]:relative min-[1880px]:max-[1919px]:left-[-7px] min-[1920px]:mx-auto min-[1920px]:w-[117px] min-[1920px]:max-w-[117px] min-[1920px]:flex-none"
              >
                {disorderSelection.includes(racer.number) && (
                  <Check
