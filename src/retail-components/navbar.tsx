'use client'
  ...
  function NavbarContent() {
    ...
    const getDisciplineReturnPath = () => {
      const p = pathname.toLowerCase()
      if (p.includes('dogs-horses') || p.includes('cani-cavalli'))
        return buildHref('/retail/dogs-horses')
      if (p.includes('dogs') && !p.includes('dogs-horses'))
        return buildHref('/retail/dogs')
      if (p.includes('horses')) return buildHref('/retail/horses')
      if (p.includes('calcio')) return buildHref('/retail/calcio')
      return buildHref('/retail/dogs-horses')
    }
      ...
      <>
        ...
        >
          <div className="relative right-1 flex flex-row items-center space-x-2">
            ...
            >
              <Image src="/dog.png" alt="Dogs" width={40} height={20} className="size-8 object-contain" />
              <Image src="/horse.png" alt="Horses" width={40} height={20} className="size-8 object-contain" />
            </Link>
