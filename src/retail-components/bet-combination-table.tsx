    ...
    <Card className="mt-2">
      <CardHeader className="grid h-14 grid-cols-3 items-center bg-accent px-3 text-accent-foreground">
        ...
        <div className="flex justify-end space-x-2">
          <Button
            variant="navbar"
            className="h-10 w-fit rounded-[1px] px-[18px] pt-[1px] text-[15px] font-semibold text-white active:bg-[#686972] hover:bg-[#46474d]"
          ...
          <Button
            variant="navbar"
            className="h-10 w-[183px] rounded-[1px] px-[18px] pt-[1px] text-[15px] font-semibold text-white active:bg-[#686972] hover:bg-[#46474d]"
            onClick={() => {
